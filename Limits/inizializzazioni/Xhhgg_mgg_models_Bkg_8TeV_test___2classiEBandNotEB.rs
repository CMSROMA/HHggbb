...
massggnewvtx_sig_m0_cat0[124.927, 120.0, 130.0];
massggnewvtx_sig_sigma0_cat0[3.3213, 0.0, 5.0];
massggnewvtx_sig_sigma1_cat0[1.4277, 0.0, 5.0];
massggnewvtx_sig_alpha_cat0[4.86583, 0., 5.]; 
massggnewvtx_sig_n_cat0[0.5, 0., 0.5]; 
massggnewvtx_sig_frac_cat0[0.15607, 0, 1.0];
...
massggnewvtx_sig_alpha_cat1[4., 0., 5.]; 
massggnewvtx_sig_n_cat1[0.4, 0., 0.7]; 
massggnewvtx_sig_frac_cat1[0.5, 0.3, 0.7];
