...
#ifndef bestJets_commonNtp_h
#define bestJets_commonNtp_h
...
class bestJets_commonNtp : public RedNtpFinalizer_commonNtp {
 ...
 public :
  ...
  bestJets_commonNtp( const std::string& dataset, const std::string& selectionType, const std::string& bTaggerType="JP" );
  virtual ~bestJets_commonNtp();
  ...
  virtual std::pair<int,int> myTwoHighestBtagJet(vector<int> jets);
  virtual int myHighestBtagJet(vector<int> jets);
