...
// used to generate this class and read the Tree.
  if (tree == 0) {                                                            
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../treeMjj_sign300_looseBtag/Radion_Radion_M-300_madgraph_default_CSV.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("../treeMjj_sign300_looseBtag/Radion_Radion_M-300_madgraph_default_CSV.root");
    }
